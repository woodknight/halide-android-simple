#ifndef HALIDE__gen_files___hello_h
#define HALIDE__gen_files___hello_h
#include <stdint.h>
...
int hello(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer);

HALIDE_FUNCTION_ATTRS
int hello_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *hello_metadata();
